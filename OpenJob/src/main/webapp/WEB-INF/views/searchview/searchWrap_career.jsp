	...
	<dd>
		<div
			...
			<ul class="career_ul" style="list-style: none; padding: 10px; padding-left: 20px;">
				<li><input type="checkbox" style="display:;" name="career" id="new"
					value="신입"> <label
				...
				<li><input type="checkbox" style="display:;" name="career" id="career"
					value="경력"> <label
					style="padding-bottom: 5px; cursor: pointer; width: 110px; font-size: 14px"
					for="career"><span id="career" style="padding: 5px 10px 5px 10px;">경력</span></label></li>
				<li><input type="checkbox" style="display:;" name="career" id="any"
					value="경력무관"> <label
					style="padding-bottom: 5px; cursor: pointer; width: 110px; font-size: 14px"
